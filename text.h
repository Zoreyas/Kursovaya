...
const std::string ERROR_OWN_LOGIN = "You can't change your current account";
...
const std::string LINE_PRICE_PER_UNIT = "Price per unit:";
const std::string LINE_TOTAL_PRICE = "Total price:";
...
const std::string LINE_VIEW_DATA_MENU = "1) View data\n2) Get price\n3) Get car by capacity\n4) Search\n5) Sort\n6) Back";
const std::string LINE_INPUT_LEFT_BORDER = "Input left border";
const std::string LINE_INPUT_RIGHT_BORDER = "Input right border";
const std::string LINE_BORDERS_SWAPPED = "Incorrect borders, borders swapped";
const std::string LINE_SEARCH_SCREEN = "Find with\n1) Title\n2) Capacity\n3) Amount\n4) Fuel consumption\n5) Price\n6) Type\n7) Back";
const std::string LINE_SORT_SCREEN = "Sort by\n1) Capacity\n2) Price\n3) Fuel consumption\n4) Amount\n5) Back";

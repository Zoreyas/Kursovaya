...
void screenAdmin(std::vector<user>*, std::vector<car>*, int*); // Admin screen (work with accounts or with data)

void screenAdminAccounts(std::vector<user>*); // Admin screen (work with accounts)
